...
class Config:
    ...
    TAKE_ACCESS_TOKEN_ENDPOINT = environ.get('RPROXY_TAKE_ACCESS_TOKEN_ENDPOINT', 'https://apitest.albarakaturk.com.tr/ocf-auth-server/auth/oauth/token')
    TAKE_ACCESS_TOKEN_TIMEOUT = int(environ.get('RPROXY_TAKE_ACCESS_TOKEN_TIMEOUT', '30'))
    CLIENT_ID = environ.get('RPROXY_CLIENT_ID')
    CLIENT_SECRET = environ.get('RPROXY_CLIENT_SECRET')
    API_ENDPOINT = environ.get('RPROXY_API_ENDPOINT', 'https://apitest.albarakaturk.com.tr/api')
    API_TIMEOUT = int(environ.get('RPROXY_API_TIMEOUT', '30'))
    PRIVATE_KEY = environ.get('RPROXY_PRIVATE_KEY')
    USER_TOKEN_TTL = timedelta(seconds=int(environ.get('RPROXY_USER_TOKEN_TTL', '1800')))
